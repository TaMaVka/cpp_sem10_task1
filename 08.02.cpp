/*
g++ -std=c++23 -Wall -Wextra -Wpedantic 08.02.cpp -o 08.02.out
./08.02.out
*/
...
public:
    ...
    friend auto operator<=(Integer const & lhs, Integer const & rhs) -> bool      { return !(rhs < lhs); }
    friend auto operator>=(Integer const & lhs, Integer const & rhs) -> bool      { return !(lhs < rhs); }
    ...
    friend auto pow(Integer base, unsigned int exp) -> Integer
    {
        ...
        Integer result(1);
        bool negative_result = base.m_is_negative && (exp % 2 != 0);
        base.m_is_negative = false;
        ...
        result.m_is_negative = negative_result;
        return result;
    }
...
int main()
{
    ...
    // %
    auto a = Integer("1234567890123456789");
    Integer b = 12345;
    Integer c = a % b;
    assert(c == 1674);
